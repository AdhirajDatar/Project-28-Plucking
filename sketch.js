...
function setup() {
	...
	//Create the Bodies Here.
	 ...
	 mango = new MANGO(700,350,50);

	 mango1 = new MANGO(700,430,50);

	 mango2 = new MANGO(770,450,50);

	 mango3 = new MANGO(570,430,50);

	 mang04 = new MANGO(610,350,50);

	 mang05 = new MANGO(500,450,50);

	 mang06 = new MANGO(470,410,55);
